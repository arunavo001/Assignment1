...
public class CustomerController {
    ...
    public ResponseEntity updateCustomerDetails(@PathVariable(name = "id") int id , @RequestBody CustomerDTO customerDTO) throws CustomerUserNameExistsException, CustomerDetailsNotFoundException, RoleTypeDetailsNotFoundException, VehiclesSubCategoryDetailsNotFoundException, BookingDetailsNotFoundException, APIException {
