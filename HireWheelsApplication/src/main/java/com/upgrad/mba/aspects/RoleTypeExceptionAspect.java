...
@ControllerAdvice
public class RoleTypeExceptionAspect {
    @ExceptionHandler(RoleTypeDetailsNotFoundException.class)
    public ResponseEntity<CustomResponse> handleRoleTypeDetailsNotFoundException(Exception e){
